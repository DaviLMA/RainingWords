...
public class GameController implements Initializable {
    ...
    private void gameStartCountdown() {
        ...
        gameCountdown.setStyle("-fx-font-family: 'Segoe UI Semibold'; -fx-font-size: 100;");
     ...
     */
    private void createPlayerLives() {   //VIDAS DO JOGADOR
        hearts = new HBox();
    ...
    private void createWordSpawn() {   //MOMENTO QUE SPAWNA AS PALAVRAS
